...
const ANALYSIS_TYPES: AnalysisType[] = [
    ...
    },
    {
        ...
        description:
            "Analyze vulnerability to malicious prompt injection attacks",
        testCases: 12,
        tokens: 1500,
        cost: 0.0015,
    },
    {
        ...
        description:
            "Test for potential data leakage and unauthorized data access",
        testCases: 8,
        tokens: 2000,
        cost: 0.002,
    },
...
export function SecurityAnalysisDialog() {
    ...
    const currentRange = useMemo(() => {
        return DEPTH_RANGES.find((range) =>
            depth >= range.min && depth <= range.max
        );
    }, [depth]);
                                    ...
                                    {ANALYSIS_TYPES.map((type, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-3 mt-2 text-xs text-gray-600">
                                                <span>
                                                    {getTestCount(type.testCases)}
                                                    {" "}
                                                    of {type.testCases} tests
                                                </span>
                                                <span className="flex items-center gap-1">
                                                    <Zap className="w-3 h-3" />
                                                    ~{Math.ceil(
                                                        type.tokens * depth / 100,
                                                    )} tokens
                                                </span>
                                            </div>
                                        </motion.button>
